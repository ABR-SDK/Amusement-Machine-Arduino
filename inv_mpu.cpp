...
#ifdef MPU_DEBUG
            Serial.print("log(\"fimrware write failed: ");
...
#ifdef MPU_DEBUG
/*
            Serial.print("log(\"Firmware compare failed addr "); 
			Serial.print(ii);
			Serial.println("\")");
            for (int i = 0; i < 10; i++) {
...
#ifdef MPU_DEBUG
    Serial.println("log(\"Firmware loaded\")");
#endif
    return 0;
}
...
#ifdef MPU_DEBUG
        Serial.println("log(\"Compass not found.\")");
#endif
        return -1;
    }
...
#ifdef MPU_DEBUG
    Serial.print("log(\"Compass sens: "); Serial.print(st->chip_cfg.mag_sens_adj[0]); Serial.print(" ");
